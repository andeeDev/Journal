            ...
            <div id="groups" class="callout clearfix margin-info padding-top">
                <div id="group17520310" class="small-12 columns l-b-r group">
                    ...
                    <div class="table-scroll">
                        <table class="hover custom size-1em m-b-n l-h-1-1">
                            <colgroup>
                                <col width="20px">
                                <col>
                                <col width="150px">
                            ...
                            <tbody>
                                <tr class="b-none">
                                    ...
                                    <td class="text-center border-right border-bottom"><a href="/journal/1/1" class="font-awesome">&#xf0ce;</a></td>
                                </tr>
                                <tr class="b-none">
...
<script type="text/javascript" src="../../public/js/custom/change_type_of_table.js"></script>
