@include('header')
    <section id="top-blocks" class="row " data-equalizer="top-blocks" data-resize="top-blocks">
        ...
        <section class="xmedium-6 columns ">
            <div class="callout paddings margin-none" data-equalizer-watch="top-blocks" style="height: 382px;">
                ...
                <div id="groups" class="callout clearfix margin-info padding-top">
                    <div id="group17520310" class="small-12 columns l-b-r group">
                        <h5 class="callout cabinet small clearfix  margin-bottom one-icon">
                            Журнали                                                                                                        <div class="h-icons">
                                <button class="size-20 white font-awesome fw-bold load-form" value="{&quot;to_name&quot;:&quot;\u0406\u041d-71&quot;,&quot;to_users&quot;:[&quot;zNbJzBbr&quot;,&quot;mcyaNy7e&quot;,&quot;W4JT8GjN&quot;,&quot;vVQafvNR&quot;,&quot;CSg51NHw&quot;,&quot;2OioKb2t&quot;,&quot;05AbOH7T&quot;,&quot;e1Lz78Ed&quot;,&quot;E1hZVjLo&quot;,&quot;O0Jg60WC&quot;,&quot;m0s29pIE&quot;,&quot;OH6x3r8G&quot;,&quot;i0XqGYSj&quot;,&quot;ggtF8mlt&quot;,&quot;tICVLXiU&quot;,&quot;xNlPjFAz&quot;,&quot;xHaS5zOb&quot;,&quot;7HQnINci&quot;,&quot;WDzdKrNM&quot;,&quot;lAyVbDzp&quot;,&quot;BeaOiCiW&quot;,&quot;brmv7LM8&quot;,&quot;gVYo5nBM&quot;,&quot;GN4LotS1&quot;,&quot;Ce7yY1Yg&quot;,&quot;04HKVDO9&quot;,&quot;RAlL5rQ8&quot;]}" title="Відправити листи" style="margin-right: 6px;"></button>
                            </div>
                        </h5>
                        <div class="table-scroll">
                            <table class="hover custom size-1em l-h-1-1">
                                <colgroup>
                                    <col width="20px">
                                    <col>
                                    <col width="150px">
                                ...
                                <tbody>
                                <tr class="b-none">
                                    <td class="text-center border-right border-bottom">1</td>
                                    <td class="border-right border-bottom">Чисельні методи</td>
                                    <td class="text-center border-right border-bottom">ІН-71</td>
                                    <td class="text-center border-right border-bottom">іспит</td>
                                    <td class="text-center border-right border-bottom"><a href="/journal/1/1/1" class="font-awesome">&#xf0ce;</a></td>
                                </tr>
                                <tr class="b-none">
                                    <td class="text-center border-right border-bottom">2</td>
                                    <td class="border-right border-bottom">Проектування баз данних</td>
                                    <td class="text-center border-right border-bottom">ІН-71</td>
                                    <td class="text-center border-right border-bottom">д/залік</td>
                                    <td class="text-center border-right border-bottom"><a href="/teacherMark" class="font-awesome">&#xf0ce;</a></td>
                                </tr>
                                <tr class="b-none">
                                    <td class="text-center border-right border-bottom">3</td>
                                    <td class="border-right border-bottom">Мат. методи досл. опер.</td>
                                    <td class="text-center border-right border-bottom">ІН-71</td>
                                    <td class="text-center border-right border-bottom">залік</td>
                                    <td class="text-center border-right border-bottom"><a href="/teacherMark" class="font-awesome">&#xf0ce;</a></td>
                                </tr>
                                </tbody>
                            </table>
